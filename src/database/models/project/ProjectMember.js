...
export default (sequelize, DataTypes) => {
	class ProjectMember extends Model {
		static associate(models) {
			ProjectMember.belongsTo(models.Project, { foreignKey: 'project_id', targetKey: 'id', constraints: false });
			ProjectMember.belongsTo(models.Member, { foreignKey: 'member_id', targetKey: 'id', constraints: false });
		}
	}
